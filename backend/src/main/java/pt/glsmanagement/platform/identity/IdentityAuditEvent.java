...
class IdentityAuditEvent {
    ...
    static IdentityAuditEvent create(String actorSubject, String actorUsername, String action,
                                     String targetUserId, String targetUsername, String previousRoles,
                                     String newRoles, String details) {
