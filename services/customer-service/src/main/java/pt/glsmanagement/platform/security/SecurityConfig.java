    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http, ObjectMapper objectMapper) throws Exception {
        return http.csrf(csrf -> csrf.disable())
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/customers", "/api/customers/**", "/api/recipients")
                                .hasAnyRole("ADMIN", "OPERATOR", "ACCOUNTING", "FRONT_DESK")
                        .requestMatchers(HttpMethod.HEAD, "/api/customers", "/api/customers/**", "/api/recipients")
                                .hasAnyRole("ADMIN", "OPERATOR", "ACCOUNTING", "FRONT_DESK")
                        .requestMatchers(HttpMethod.POST, "/api/vat-validations")
                                .hasAnyRole("ADMIN", "OPERATOR", "FRONT_DESK")
                        .requestMatchers(HttpMethod.POST, "/internal/v1/customers/existence").hasRole("ADMIN")
