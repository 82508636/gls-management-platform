package pt.glsmanagement.pickup.security;
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http, ObjectMapper objectMapper) throws Exception {
        return http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/pickup-points", "/api/pickup-points/**")
                                .hasAnyRole("ADMIN", "OPERATOR", "ACCOUNTING", "FRONT_DESK")
                        .requestMatchers(HttpMethod.HEAD, "/api/pickup-points", "/api/pickup-points/**")
                                .hasAnyRole("ADMIN", "OPERATOR", "ACCOUNTING", "FRONT_DESK")
                        .requestMatchers(HttpMethod.POST, "/api/pickup-points")
                                .hasAnyRole("ADMIN", "OPERATOR", "FRONT_DESK")
                        .requestMatchers(HttpMethod.PUT, "/api/pickup-points/**")
                                .hasAnyRole("ADMIN", "OPERATOR", "FRONT_DESK")
