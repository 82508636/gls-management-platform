package pt.glsmanagement.identity.security;
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http, ObjectMapper objectMapper) throws Exception {
        return http.csrf(csrf -> csrf.disable())
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.GET, "/internal/v1/access-decisions/self").authenticated()
                        .requestMatchers(HttpMethod.HEAD, "/internal/v1/access-decisions/self").authenticated()
                        .requestMatchers(HttpMethod.GET, "/api/admin/users", "/api/admin/users/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.HEAD, "/api/admin/users", "/api/admin/users/**").hasRole("ADMIN")
